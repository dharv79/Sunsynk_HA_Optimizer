...
_planning = _load_module("planning.py", "planning")
...
@pytest.fixture(scope="session")
def planning():
    """The pure planning module, loaded without a running Home Assistant."""
    return _planning
...
def make_day(**overrides):
    ...
    day = {
        ...
        "day_load_kwh": 12.0,
        "day_grid_import_kwh": 3.0,
        "day_grid_export_kwh": 0.5,
        "is_full_day": False,
        "flux1_end": "02:30",
